...
class DriveConstants:
    ...
    kMaxSpeedMetersPerSecond = .2 # was 4?
    ...
    kTrackWidth = units.inchesToMeters(26)
    # Distance between centers of right and left wheels on robot
    kWheelBase = units.inchesToMeters(26)
...
class OIConstants:
    ...
    kDriveDeadband = 0.1 #input range of no output, original 0.05
